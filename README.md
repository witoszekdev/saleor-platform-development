...
This is modified version of Saleor Platform that can be used for local development with `host` network
...
_Keep in mind this repository is for local development only and is not meant to be deployed in any production environment! If you're not a developer and just want to try out Saleor you can check our [live demo](https://demo.saleor.io/)._
